...
# JSON dosyasını oku
with open("datas/article_to_article/article_to_article_sub_graph.json", "r") as f:
    data = json.load(f)
...
with open("datas/article_to_article/article_to_article_centrality.json", "w") as dosya:
