...
def calculate_variance(comun_id):
    cursor.execute("SELECT betweenness, closeness, eigenvector FROM article_to_article_centrality WHERE comun_id = %s", (comun_id,))
...
cursor.execute("SELECT DISTINCT comun_id FROM article_to_article_centrality")
